      ...
      {!isLoading && loreItems.length > 0 && (
        <>
          <div className="flex-grow max-w-[400px] mx-auto w-full px-4">
            ...
            {/* View on X button */}
            <div className="mb-8">
              <a href={currentItem["Original post (link)"]} target="_blank" rel="noopener noreferrer" className="bg-white text-[#2600FF] border border-[#2600FF] rounded-full px-4 py-2 text-base inline-flex items-center">
          ...
          <div className="mt-auto pb-4 max-w-[400px] mx-auto w-full">
            ...
            <div className="flex justify-center mb-2">
              <div className="bg-[#E4E4E4] text-[#696969] text-sm px-4 py-2 inline-block">
                Site hits: <span className="font-bold">{hitCount.toLocaleString()}</span>
              </div>
            </div>
            {/* Created by */}
